...
def run_pogpn_pathwise_elbo_gvr(exp_config_path: str):
    """Run the POGPN pathwise ELBO without noise prior."""
    exp = POGPNCommon(
        ...
        model_config_path=os.path.join(
            ...
            "configs",
            "model_configs",
            "pogpn_pathwise_1.0beta_ELBO_1.0IPRatio_GVR.yaml",
        ),
        mlflow_run_name_prefix="pogpn_pathwise_1.0beta_ELBO_1.0IPRatio_GVR",
...
def run_pogpn_pathwise_pll_gvr(exp_config_path: str):
    """Run the POGPN pathwise PLL without noise prior."""
    exp = POGPNCommon(
        exp_config_path=exp_config_path,
        model_config_path=os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "configs",
            "model_configs",
            "pogpn_pathwise_1.0beta_PLL_1.0IPRatio_GVR.yaml",
        ),
        mlflow_run_name_prefix="pogpn_pathwise_1.0beta_PLL_1.0IPRatio_GVR",
        log_mlflow_to_gitlab=True,
        run_note="Using default likelihood.",
    )
    save_script(exp.mlflow_manager, __file__)
...
def run_pogpn_nodewise_elbo_gir(exp_config_path: str):
    """Run the POGPN nodewise ELBO with GreedyImprovementReduction."""
    exp = POGPNCommon(
        exp_config_path=exp_config_path,
        model_config_path=os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "configs",
            "model_configs",
            "pogpn_nodewise_1.0beta_ELBO_1.0IPRatio_GIR.yaml",
        ),
        mlflow_run_name_prefix="pogpn_nodewise_1.0beta_ELBO_1.0IPRatio_GIR",
        log_mlflow_to_gitlab=True,
...
def run_pogpn_nodewise_elbo_gvr(exp_config_path: str):
    """Run the POGPN nodewise ELBO with GreedyVarianceReduction."""
    exp = POGPNCommon(
        exp_config_path=exp_config_path,
        model_config_path=os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "configs",
            "model_configs",
            "pogpn_nodewise_1.0beta_ELBO_1.0IPRatio_GVR.yaml",
        ),
        mlflow_run_name_prefix="pogpn_nodewise_1.0beta_ELBO_1.0IPRatio_GVR",
        log_mlflow_to_gitlab=True,
        run_note="Using GreedyVarianceReduction inducing point allocator.",
    )
    save_script(exp.mlflow_manager, __file__)
    exp.run_experiment()
    print("End of the script.")
...
def run_pogpn_nodewise_pll_gvr(exp_config_path: str):
    """Run the POGPN nodewise PLL with GreedyVarianceReduction."""
    exp = POGPNCommon(
        exp_config_path=exp_config_path,
        model_config_path=os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
            "configs",
            "model_configs",
            "pogpn_nodewise_1.0beta_PLL_1.0IPRatio_GVR.yaml",
        ),
        mlflow_run_name_prefix="pogpn_nodewise_1.0beta_PLL_1.0IPRatio_GVR",
        log_mlflow_to_gitlab=True,
        run_note="Using GreedyVarianceReduction inducing point allocator.",
    )
    save_script(exp.mlflow_manager, __file__)
...
def run_pogpn_pathwise_pll_gir(exp_config_path: str):
    """Run the POGPN pathwise PLL with GreedyImprovementReduction."""
    exp = POGPNCommon(
        exp_config_path=exp_config_path,
        model_config_path=os.path.join(
            os.path.dirname(os.path.dirname(__file__)),
